...
const MENU = [
  // — Кофе —
  { id: 1, name: "Эспрессо",        cat: "Кофе", price: 120, desc: "Классический крепкий эспрессо из свежеобжаренного зерна", img: "" },
  ...
  { id: 6, name: "Раф ванильный",   cat: "Кофе", price: 250, desc: "Эспрессо, сливки и ваниль, взбитые в нежный напиток", img: "" },
  { id: 7, name: "Бамбл-кофе",      cat: "Кофе", price: 220, desc: "Эспрессо с апельсиновым соком и льдом — летняя классика", img: PH.bumble },

  // — Не кофе —
  { id: 8,  name: "Какао",                    cat: "Не кофе", price: 190, desc: "Горячее какао на молоке — как в детстве", img: "" },
  { id: 9,  name: "Горячий шоколад с маршмеллоу", cat: "Не кофе", price: 220, desc: "Густой шоколад с воздушными маршмеллоу", img: "" },
  { id: 10, name: "Матча-латте",              cat: "Не кофе", price: 260, desc: "Японский чай матча на молоке, мягкий и бодрящий", img: "" },
  ...
  { id: 13, name: "Восточная пахлава",     cat: "Десерты", price: 150, desc: "Медовая пахлава с орехами — идеально к кофе", img: "" },
  { id: 14, name: "Чизкейк",               cat: "Десерты", price: 280, desc: "Нежный чизкейк на песочной основе", img: "" },
];
